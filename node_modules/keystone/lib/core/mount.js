...
function mount(mountPath, parentApp, events) {
  debug('mounting');
	...
	if (!this.get('mongo')) {
		...
		var dbUrl = process.env.MONGO_URI || process.env.MONGO_URL || process.env.MONGODB_URL || process.env.MONGOLAB_URI || process.env.MONGOLAB_URL || (process.env.OPENSHIFT_MONGODB_DB_URL || 'mongodb://localhost/police-utility');
